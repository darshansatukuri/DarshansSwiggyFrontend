...
/*    <div className="regionCheckboxContainer">
                <label>South Indian</label>
                <input type="checkbox"  value="south-indian" checked={region.includes("south-indian")}  onChange={handleRegionChange} checked={region.includes("")} />
              </div>
              <div className="regionCheckboxContainer">
                <label>North Indian</label>
                <input type="checkbox"  value="north-indian" checked={region.includes("north-indian")}  onChange={handleRegionChange} checked={region.includes("")} />
              </div>
              <div className="regionCheckboxContainer">
                <label>Chinese</label>
                <input type="checkbox"   value="chinese"  checked={region.includes("chinese")}  onChange={handleRegionChange} checked={region.includes("")}   />
              </div>
              <div className="regionCheckboxContainer">
                <label>Bakery</label>
                <input type="checkbox"  value="bakery"  checked={region.includes("bakery")}  onChange={handleRegionChange} checked={region.includes("")}  />
              </div>   */